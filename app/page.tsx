                ...
                <div className={"ab-list flex-col"}>
                    <div>
                        ...
                        <div className={"ab-item"}>
                            <div className={"clock"}>
                                <div className={"minutes-arrow"} style={{rotate:360/60*minutes+"deg"}}></div>
                                <div className={"hours-arrow"} style={{rotate:360/12*hours+360/12/60*minutes+"deg"}}></div>
                            </div>
                            <div>
                                {testDate}
                            </div>
                    ...
                    <div>
                        ...
                        <div className={"ab-item clock"}>item</div>
                    </div>
                    <div>
